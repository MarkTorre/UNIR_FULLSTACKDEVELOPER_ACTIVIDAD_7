...
WHERE m.fk_restaurantes = @RESTAURANTE
...
WHERE r.fk_clientes = @CLIENTE_ID
	AND r.fk_mesas = @MESA_ID;
...
SET @FECHA_MINIMO = '2026-06-01 10:00:00';
SET @FECHA_MAXIMO = '2026-06-03 10:00:00';
...
WHERE r.id = @RESTAURANTE_ID
	AND re.fecha_reserva BETWEEN  @FECHA_MINIMO AND @FECHA_MAXIMO
GROUP BY c.id
